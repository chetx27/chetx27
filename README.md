...
### 🔐 NexusVault
A trustless on-chain dead man's switch for crypto inheritance. Heartbeat-based, no intermediaries, no archaeologists.

`Solidity` `Base Sepolia` `Next.js 14` `Three.js` `Hardhat`

[![Repo](https://img.shields.io/badge/View%20Repo-%23121011?style=for-the-badge&logo=github&logoColor=white)](https://github.com/chetx27/NexusVault)

</td>
<td width="50%">

### ⚡ AgentTip
Web monetization on the x402/HTTP 402 protocol — AI agents micropay creators per request, humans tip in USDC on-chain.

`x402` `USDC` `Base` `Node.js` `AI Agents`

[![Repo](https://img.shields.io/badge/View%20Repo-%23121011?style=for-the-badge&logo=github&logoColor=white)](https://github.com/chetx27/AgentTip)
...
| Event | Project | Track |
|-------|---------|-------|
| 🏗️ ETHMumbai 2026 | NexusVault | ENS · Fileverse · HeyElsa · EAS |
| ⚡ ETH India | NexusVault (v1) | Chainlink · Push Protocol · The Graph |
...
**Base Sepolia** · Building at the intersection of AI × Web3

<a href="https://collectors.poap.xyz/token/7573666">
  <img src="https://assets.poap.xyz/poap-token-7573666-image.png" width="120" alt="POAP #7573666"/>
</a>

*[POAP #7573666](https://collectors.poap.xyz/token/7573666)*
...
![Base](https://img.shields.io/badge/base-%230052FF.svg?style=for-the-badge&logo=coinbase&logoColor=white)
